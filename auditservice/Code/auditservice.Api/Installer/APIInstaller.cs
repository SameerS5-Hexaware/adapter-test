...
using ElmahCore.Mvc;
using ElmahCore;
using auditservice.Api.Filters;
using auditservice.Business.Installer;

namespace auditservice.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "auditservice API", Version = version + "-" + branch});
            });
