...
using ElmahCore.Mvc;
using ElmahCore;
using manageservice.Api.Filters;
using manageservice.Business.Installer;

namespace manageservice.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "manageservice API", Version = version + "-" + branch});
            });
